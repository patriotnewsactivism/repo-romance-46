// Mobile-friendly layout implementation with error handling
...
function isMobileViewport() {
  try {
    ...
    console.error('Error detecting viewport size:', e);
    return false;
  }
}
...
function initializeLayout() {
  try {
    ...
    // Fallback to viewport detection if initialization fails
    applyLayout(isMobileViewport());
  }
}
...
window.toggleMobileLayout = function(forceMobile) {
  try {
    ...
    console.error('Error toggling mobile layout:', e);
  }
};
...
window.resetMobileLayout = function() {
  try {
    ...
    console.error('Error resetting mobile layout:', e);
  }
};
